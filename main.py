...
from admintf import (
    ...
    get_join_requirements, check_user_joined, broadcast_to_all_bots, broadcast_to_freemium_bots, broadcast_to_premium_bots, list_admin_bot_ids,    handle_schedule_user_broadcast, handle_schedule_group_broadcast, handle_schedule_channel_broadcast, handle_schedule_all_broadcast,
...
@bot.message_handler(commands=['listadminbot'])
    def handle_list_admin_bot_ids(message: telebot.types.Message) -> None:
        list_admin_bot_ids(message)
